...
export class CategorieComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.categorieService
      ...
      .subscribe(
        (res: HttpResponse<ICategorie[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: ICategorie[] | null, headers: HttpHeaders, page: number): void {
